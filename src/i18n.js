...
const resources = {
  en: {
    translation: {
      ...
      "form.keyword.copy": "Copy secret key",
      "form.keyword.copied": "Secret key copied",
  ...
  es: {
    translation: {
      ...
      "form.keyword.copy": "Copiar clave secreta",
      "form.keyword.copied": "Clave copiada al portapapeles",
